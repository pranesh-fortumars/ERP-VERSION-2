      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-slate-200">
        ...
        <div className="flex flex-wrap items-center gap-4">
           <button 
             ...
             className="px-6 py-2.5 bg-white border border-slate-200 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-900 hover:shadow-lg transition-all active:scale-95 flex items-center gap-2"
           >
        ...
        <div className="xl:col-span-2 industrial-card flex flex-col bg-white border border-slate-100 shadow-sm rounded-[48px] overflow-hidden">
          <div className="p-8 border-b border-slate-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 bg-slate-50/20">
            <div>
               ...
               <p className="text-[9px] font-bold text-slate-900 uppercase tracking-widest mt-1">Multi-Node SKU Identification</p>
            </div>
          ...
          <div className="overflow-x-auto no-scrollbar">
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50/40 text-[9px] font-black uppercase tracking-widest text-slate-900">
                    ...
                    <td className="py-8 px-10">
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          ...
                          <p className="text-[9px] font-black text-slate-900 uppercase tracking-widest mt-1.5 flex items-center gap-2">
                    ...
                    <td className="py-8 px-10 text-right">
                        <div className="flex items-center gap-8 justify-end">
                           <div className="text-right">
                              <p className="text-[9px] font-black text-slate-900 uppercase tracking-widest mb-1 leading-none">Units</p>
           ...
           <div className="industrial-card p-10 bg-blue-600 text-white rounded-[48px] overflow-hidden relative group min-h-[450px] flex flex-col justify-between shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                 <div>
                    ...
                    <p className="text-blue-50 text-xs font-bold leading-relaxed">Storage utilization is at <span className="text-white font-black italic">Theoretical Peak</span>. Scalability check recommended.</p>
                 </div>
                 <div className="space-y-6">
                    {warehouses.map((wh, i) => (
                      <div key={i} className="space-y-2.5">
                        <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-white font-black">
                          <span>{wh.name}</span>
            ...
            >
              ...
              <div className="flex justify-between items-start mb-12">
                <div>
                  ...
                  <p className="text-slate-900 font-black text-[10px] mt-2 uppercase tracking-[0.3em]">Supply Chain Ledger Entry</p>
                </div>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <form onSubmit={addItem} className="space-y-8">
                 <div className="space-y-3">
                   <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Asset Nomenclature</label>
                   <input 
                     required
                     type="text" 
                 ...
                 <div className="grid grid-cols-2 gap-8">
                   <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Domain Classification</label>
                     <select 
                   ...
                   <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Batch Quantum (Quantity)</label>
                     <input 
                       required
                       type="number" 
                       placeholder="0.00" 
                 ...
                 <div className="grid grid-cols-2 gap-8">
                   <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Target Cluster (Warehouse)</label>
                     <select 
                       className="w-full bg-slate-50 border-none rounded-2xl py-5 px-8 text-sm font-black outline-none focus:ring-4 focus:ring-blue-600/5 text-slate-900 appearance-none shadow-inner"
                   ...
                   <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Market Valuation</label>
                     <input 
                       required
                       type="text" 
                       placeholder="₹0.00" 
