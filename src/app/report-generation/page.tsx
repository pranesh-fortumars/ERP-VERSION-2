  ...
  return (
    <div className="space-y-10 max-w-[1600px] mx-auto pb-12 px-4 md:px-0">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div>
           <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-600 text-[14px] font-bold  tracking-[0.2em] mb-4">
            <FiLayers /> Intelligence Engine v3.2
          </div>
          <h1 className="text-5xl font-serif-professional tracking-tight tracking-tight text-slate-900 ">Analytical Intelligence</h1>
        ...
        <div className="flex flex-wrap items-center gap-4">
           <button 
             ...
             className="px-8 py-3 bg-white border border-slate-200 rounded-2xl text-[14px] font-bold transition-all flex items-center gap-2  tracking-widest hover:shadow-lg active:scale-95"
           >
           ...
           <button 
             ...
             className="px-6 py-3 bg-white border border-slate-200 rounded-2xl text-[14px] font-bold transition-all flex items-center gap-2  tracking-widest hover:shadow-lg active:scale-95"
           >
            <FiPlus /> Register Template
          </button>
          <button 
            onClick={startReportGeneration} disabled={isGenerating || isPending}
            className="px-10 py-3 bg-blue-600 text-white rounded-2xl text-[14px] font-bold shadow-xl shadow-blue-600/30 hover:bg-blue-700 transition-all flex items-center gap-3  tracking-[0.3em] relative overflow-hidden active:scale-95"
          >
          ...
          <div className="bg-white  rounded-[40px] border border-slate-200 border-slate-200 p-10 shadow-sm relative overflow-hidden group">
            ...
            <div className="space-y-8 relative z-10">
              <div className="space-y-3">
                <label className="text-[14px] font-bold  tracking-widest text-slate-900 ml-1">Analytical Domain</label>
                <div className="relative group/select">
                  ...
                  <select 
                    ...
                    className="w-full bg-slate-50  border-none rounded-2xl py-4.5 pl-14 pr-6 text-base font-bold outline-none focus:ring-2 focus:ring-blue-500/10 text-slate-900 appearance-none cursor-pointer"
                  >
              ...
              <div className="space-y-3">
                <label className="text-[14px] font-bold  tracking-widest text-slate-900 ml-1">Temporal Horizon</label>
                <div className="relative group/select">
              ...
              <div className="pt-6 space-y-5">
                <div className="p-6 bg-blue-500/5 /10 rounded-[32px] border border-blue-500/10">
                  <p className="text-[14px] font-bold  text-blue-500 tracking-[0.2em] mb-2 leading-none">Status: Stable</p>
                  <div className="flex items-center justify-between">
                      <span className="text-base font-bold text-slate-900 text-slate-900">Last Compilation</span>
                      <span className="text-[14px] font-bold text-slate-900">Mar 28, 2024</span>
                  </div>
                </div>
                <p className="text-[14px] text-slate-900 font-bold px-3 leading-relaxed  tracking-tight">
        ...
        <div className="xl:col-span-2 space-y-8">
           <div className="bg-white  rounded-[40px] border border-slate-200 border-slate-200 p-10 shadow-sm relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-12">
                 <div>
                   <h3 className="text-3xl font-serif-professional tracking-tight text-slate-900 text-slate-900 tracking-tighter  leading-none mb-1">Fiscal Trajectory</h3>
                   <p className="text-[14px] font-bold text-slate-900  tracking-widest">Revenue Vectors & Performance Anchors</p>
                 </div>
                 <div className="flex items-center gap-3 text-emerald-500 bg-emerald-500/10 px-5 py-2 rounded-2xl border border-emerald-500/10 font-bold text-base">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white border border-slate-100 rounded-[40px] p-12 flex flex-col justify-center text-center relative overflow-hidden group shadow-sm hover:shadow-xl transition-all duration-700">
                 ...
                 <h4 className="text-3xl font-serif-professional tracking-tight text-slate-900 mb-4  tracking-tighter leading-none ">Automated Archival</h4>
                 ...
                 <button className="py-6 bg-blue-600 text-white rounded-[32px] text-[14px] font-bold  tracking-[0.4em] hover:bg-blue-700 transition-all shadow-xl shadow-blue-600/20 active:scale-95 mx-auto px-16">
                   Configure cron
                 </button>
              </div>
           </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="flex justify-between items-start mb-12">
                <div>
                  <h2 className="text-4xl font-serif-professional tracking-tight tracking-tighter text-slate-900  leading-none mb-2">Register Blueprint</h2>
                  <p className="text-slate-900 font-bold text-[14px]  tracking-[0.3em]">Analytical Intelligence Manifest</p>
                </div>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <form onSubmit={handleAddTemplate} className="space-y-8">
                <div className="space-y-3">
                  <label className="text-[14px] font-bold  tracking-widest text-slate-900 ml-1">Template Designation</label>
                  <input 
                    required
                    type="text" 
                    placeholder="e.g. Sales Master Audit v3" 
                    className="w-full bg-slate-50  border-none rounded-2xl py-5 px-8 text-lg font-bold outline-none focus:ring-2 focus:ring-blue-500/10 text-slate-900"
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <label className="text-[14px] font-bold  tracking-widest text-slate-900 ml-1">Target Cluster</label>
                    <select 
                      className="w-full bg-slate-50  border-none rounded-2xl py-5 px-8 text-lg font-bold outline-none focus:ring-2 focus:ring-blue-500/10 text-slate-900 appearance-none cursor-pointer"
                  ...
                  <div className="space-y-3">
                    <label className="text-[14px] font-bold  tracking-widest text-slate-900 ml-1">Temporal Frequency</label>
                    <select 
                      className="w-full bg-slate-50  border-none rounded-2xl py-5 px-8 text-lg font-bold outline-none focus:ring-2 focus:ring-blue-500/10 text-slate-900 appearance-none cursor-pointer"
                ...
                <button type="submit" className="w-full mt-6 py-6 bg-blue-600 text-white rounded-[32px] font-bold text-base  tracking-[0.4em] shadow-2xl shadow-blue-600/30 hover:bg-blue-700 transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3">
