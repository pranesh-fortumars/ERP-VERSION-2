...
const AccountingPage = () => {
  ...
  const summary = [
    ...
    { label: 'Outward Transactions', value: '₹8.4 Lakh', delta: '-5%', isUp: false, icon: <FiTrendingUp /> },
  ...
  const filteredTxns = useMemo(() => {
    ...
    const handleTransactionsSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
  ...
  return (
    <div className="space-y-10 max-w-[1600px] mx-auto pb-12 transition-all">
      ...
      <div className="industrial-card flex flex-col bg-white border border-slate-100 shadow-sm rounded-[40px] overflow-hidden">
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-xl bg-white rounded-[40px] p-10 md:p-14 border border-blue-500/10 shadow-3xl"
            >
