      ...
      <div className="industrial-card flex flex-col bg-white border border-slate-100 shadow-sm rounded-[48px] overflow-hidden">
        <div className="p-8 border-b border-slate-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 bg-slate-50/20">
          <div>
             ...
             <p className="text-[9px] font-bold text-slate-900 uppercase tracking-widest mt-1">Multi-Node Capital Correlation</p>
          </div>
              ...
              {filteredTxns.map((t) => (
                <tr key={t.id} className="group hover:bg-blue-50/30 transition-all cursor-pointer">
                  ...
                  <td className="py-6 px-6">
                     ...
                     <p className="text-[8px] font-bold text-slate-900 uppercase mt-0.5">Corporate Node X-1</p>
                  </td>
                  <td className="py-6 px-6">
                  ...
                  <td className="py-6 px-10 text-right">
                     <span className="text-[10px] font-black text-slate-900 uppercase">{t.date}</span>
                  </td>
                </tr>
              ))}
            </tbody>
            ...
            >
              <div className="flex justify-between items-start mb-12">
                <div>
                  ...
                  <p className="text-slate-900 font-black text-[10px] mt-2 uppercase tracking-[0.3em]">Treasury Ledger Artifact</p>
                </div>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <form onSubmit={handleFluxSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Flux Quantum (Amount)</label>
                    <input 
                      required
                      type="text" 
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Flux Vector (Type)</label>
                    <select 
