        ...
        <div className="xl:col-span-3 space-y-8">
           <div className="p-8 bg-white rounded-[40px] border border-slate-100 shadow-sm flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex gap-4">
                 <button className="padding-6 py-3.5 bg-white border border-slate-100 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-900 hover:text-blue-600 transition-all active:scale-95 px-6">
                    Audit Log
                 </button>
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center gap-6 w-full md:w-auto justify-end">
                       <div className="text-right flex flex-col items-end">
                          <p className="text-[9px] font-black text-slate-900 uppercase tracking-widest leading-none mb-1">Target Deadline</p>
           ...
           <div className="p-10 bg-blue-600 rounded-[48px] overflow-hidden relative group min-h-[400px] flex flex-col justify-between shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col flex-1 justify-between">
                 <div>
                    ...
                    <p className="text-blue-50 text-xs font-bold leading-relaxed">Task resolution velocity has increased by <span className="text-white font-black">22.4%</span> this procurement cycle.</p>
                 </div>
              ...
              <div className="space-y-6">
                 {[
                   ...
                   <div key={i} className="space-y-2 group cursor-pointer">
                      <div className="flex justify-between items-center text-[10px] font-black uppercase italic text-slate-900">
                         <span>{n.node}</span>
            ...
            >
              <div className="flex justify-between items-start mb-12">
                <div>
                  ...
                  <p className="text-slate-900 font-black text-[10px] mt-2 uppercase tracking-[0.3em]">Operational Network Ledger</p>
                </div>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <form onSubmit={addTask} className="space-y-8">
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Task Nomenclature</label>
                  <input 
                    required
                    type="text" 
                ...
                <div className="grid grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Execution Deadline</label>
                    <input 
                      required
                      type="date" 
                      className="w-full bg-slate-50 border-none rounded-2xl py-5 px-8 text-sm outline-none focus:ring-4 focus:ring-blue-600/5 font-black text-slate-900"
